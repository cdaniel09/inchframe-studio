...
async function ProjectContent({params}:{params:Promise<{id:string}>}) {
  ...
  return <main className="portal-page">
    ...
    <section className="project-content"><div className="shell project-layout">
      <aside><nav className="project-nav"><a href="#overview">Quote + assignment</a>{showProduction&&<><a href="#advanced">Advanced brief</a><a href="#seeds">Seed library <b>{seeds.length}</b></a><a href="#audio">Audio <b>{audio.length}</b></a><a href="#review">Review queue <b>{reviews.length}</b></a><a href="#delivery">Delivery <b>{deliveries.length}</b></a></>}</nav>
      ...
      <div className="project-sections">
        ...
        {showProduction&&<><AssetSection title="Image seeds" id="seeds" empty="No seed images have been added yet." assets={seeds} comments={bundle.comments} projectId={id} canDecide={false}/><AssetSection title="Reference audio" id="audio" empty="No audio references have been added yet." assets={audio} comments={bundle.comments} projectId={id} canDecide={false}/><AssetSection title="Review queue" id="review" empty={admin||creatorViewer?'Upload a review version when it is ready for the client.':'Nothing needs your review right now.'} assets={reviews} comments={bundle.comments} projectId={id} canDecide={canDecide}/><AssetSection title="Final delivery" id="delivery" empty="Approved delivery files will appear here." assets={deliveries} comments={bundle.comments} projectId={id} canDecide={canDecide}/></>}
      </div>
    </div></section>
  </main>;
}
